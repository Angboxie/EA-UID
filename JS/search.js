...
const products = [
    /* uplift */
    { feeling: 'uplift', name: 'Zest Myrtlte', scent: 'green mango · citrus peel · fresh peel', price: '22.95', img: 'assets/zest-myrtle.png', link: 'product-zest-myrtle.html' },
    ...
    { feeling: 'uplift', name: 'Lemon Myrle', scent: 'lemon bark · eucalyptus leaf · light florals', price: '22.95', img: 'assets/lemon-myrtle.png', link: '#' },
...
/* products to search through — same as shop.js */
const products = [
    /* uplift */
...
/* recent searches — saved in sessionStorage */
